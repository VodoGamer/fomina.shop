...
export const PurchaseSchema = object({
	name: string("имя не задано", [minLength(3, "длина имени должна быть от трёх символов"), maxLength(255, "длина имени не должна быть больше 255 символов")]),
	address: string("адрес не задан", [minLength(3, "длина адреса должна быть от трёх символов"), maxLength(255, "длина адреса не должна быть больше 255 символов")]),
