...
const Categories: Component = () => {
	...
	return (
		<Show fallback={<div class="burger-menu__error">Произошла ошибка при загрузке категорий :(</div>} when={!categories.error}>
			<For fallback={
				<div class="burger-menu__loading">Загружаем категории...</div>
			} each={categories()}>
				{(category: Category) =>
