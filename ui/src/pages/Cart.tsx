...
const getProducts = async (productIds: string[]): Promise<Product[]> => {
...
const calculateOverallSum = (products: Product[]): number => {
    let sum: number = 0;
...
const Cart: Component = () => {
    ...
    const [products] = createResource(product_ids, getProducts);
